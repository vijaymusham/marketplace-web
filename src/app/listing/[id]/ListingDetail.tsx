            ...
            <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-1">
                    ...
                    <button
                        ...
                        className={`flex h-10 w-10 items-center justify-center rounded-full transition-colors ${liked
                    ...
                    <div className="mt-3 flex gap-2 overflow-x-auto px-4 scrollbar-hide sm:mx-6 sm:px-0 lg:mx-0">
                        {images.map((src, i) => (
                            <button
                                ...
                                type="button"
                                onClick={() => setActive(i)}
                                className={`relative h-[4.25rem] w-[4.25rem] shrink-0 overflow-hidden rounded-xl transition ${active === i
                ...
                <div className="grid gap-10 lg:grid-cols-12 lg:gap-12">
                    ...
                    <section className="lg:col-span-5">
                        ...
                        <p className="mt-5 flex items-center justify-between text-xs font-medium text-slate-400">
                            <span>AD ID {1848200000 + Number(listing.id)}</span>
