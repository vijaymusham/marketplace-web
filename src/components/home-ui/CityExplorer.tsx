...
export default function CityExplorer() {
    ...
    return (
        /* Tint matches layout themeColor `#e0e1fa` (primary/15) */
        <section className="">
            <div className="mx-auto max-w-7xl px-4 pt-4 pb-2 sm:px-6 sm:pt-5 sm:pb-3 lg:px-8 lg:pt-6 lg:pb-4">
                ...
                <div className="relative mt-3 sm:mt-4 ">
                    <Stagger
                        className=" flex gap-3 overflow-x-auto scroll-smooth px-4 pb-0.5 scrollbar-hide snap-x snap-mandatory sm:mx-0 sm:gap-4 sm:px-0 md:gap-5"
                        stagger={0.055}
                    >
