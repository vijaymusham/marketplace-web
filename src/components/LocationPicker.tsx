  ...
  return (
    <div className="relative hidden md:block">
      ...
      >
        ...
        <span className="flex items-center gap-1 text-sm font-semibold text-slate-500 hover:text-primary">
          <span className="max-w-[160px] truncate">Select location</span>
